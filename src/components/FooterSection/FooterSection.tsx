import cls from "./FooterSection.module.scss";
      ...
      <article className={cls.footerArticle}>
        ...
        <section className={cls.footerSection}>
          <nav className={cls.Navbar}>
            {FOOTER_NAVBAR_ITEMS.map((item, id) => (
              <a key={id} href="">
                {item}
              </a>
            ))}
        ...
        <section className={cls.footerSection}>
          <nav className={cls.Navbar}>
            {FOOTER_INFO_COLUMN.map((item, id) => (
              <a key={id} href="">
                {item}
              </a>
            ))}
        ...
        <section className={cls.footerSection}>
          ...
          <div className={cls.footerDiv}>
            {FOOTER_ICONS.map(({ component: IconComponent, id }) => (
              <IconComponent className={cls.icons} key={id} />
            ))}
          </div>
